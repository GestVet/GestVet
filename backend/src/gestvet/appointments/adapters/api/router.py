...
from gestvet.appointments.adapters.api.dependencies import (
    AppointmentRepositoryDep,
    AppointmentTypeRepositoryDep,
    PetDirectoryDep,
    ScheduleDirectoryDep,
)
from gestvet.appointments.adapters.api.schemas import (
...
from gestvet.appointments.domain.entities import AppointmentStatus
from gestvet.appointments.domain.exceptions import (
    AppointmentNotFound,
...
from gestvet.appointments.ports.repositories import AppointmentQuery
from gestvet.appointments.use_cases.book_appointment import (
    BookAppointment,
    BookAppointmentCommand,
)
from gestvet.appointments.use_cases.change_status import (
    ChangeAppointmentStatus,
    ChangeStatusCommand,
)
from gestvet.appointments.use_cases.list_appointments import ListAppointments, scope_to
from gestvet.appointments.use_cases.open_emergency import OpenEmergency, OpenEmergencyCommand
