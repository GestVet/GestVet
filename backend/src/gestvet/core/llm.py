...
El asistente de IA ayuda al veterinario (resúmenes, alertas) y nunca decide por
él. Este módulo solo dice qué se le pide a un modelo: una respuesta JSON con una
forma dada. Cómo se pide, y a quién, es un adaptador: hoy `llm_openrouter`.
