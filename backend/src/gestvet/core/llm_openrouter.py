...
- El razonamiento va apagado: un resumen no lo necesita y se cobraría como
  salida.
...
logger = get_logger("gestvet.llm")

# Poca variación: el mismo historial debería resumirse igual cada vez.
_TEMPERATURE = 0.2
_FENCE = "```"
